  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="glass-card p-4 md:p-6 col-span-2">
          <h3 className="text-xl font-bold text-binance-text mb-4">BTC / USD</h3>
        ...
        <div className="glass-card p-4 md:p-6 col-span-1">
          <h3 className="text-xl font-bold text-binance-text mb-4">Referral Program</h3>
          ...
          <div className="mb-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-bitcoin mb-1">15%</div>
                <div className="text-sm text-binance-text/70">from friends' mining</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-bitcoin mb-1">10%</div>
                <div className="text-sm text-binance-text/70">from referrals' mining</div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-binance-text/70">Link ID</span>
              <span className="text-sm text-binance-text/70">Landing ID</span>
            </div>
            <div className="bg-binance-light/30 rounded px-3 py-2 text-binance-text/90 mb-2 truncate">
          ...
          <div className="mt-6">
            <h4 className="text-lg font-medium text-binance-text mb-2">Social sharing</h4>
            <div className="flex justify-center space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-[#3b5998]/10 flex items-center justify-center text-[#3b5998] hover:bg-[#3b5998]/20 transition-colors"
              >
              ...
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-[#0088cc]/10 flex items-center justify-center text-[#0088cc] hover:bg-[#0088cc]/20 transition-colors"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-[#E1306C]/10 flex items-center justify-center text-[#E1306C] hover:bg-[#E1306C]/20 transition-colors"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
